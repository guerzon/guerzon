...
- [guerzon/ansible-role-vaultwarden](https://github.com/guerzon/ansible-role-vaultwarden) - Ansible role for Vaultwarden.
- [guerzon/offsec-exploits-python](https://github.com/guerzon/offsec-exploits-python) - Python exploit code for popular CVEs. Rewrites (i.e. Lester's version).
- [bettergov](https://github.com/bettergovph) - A volunteer-led tech initiative committed to creating #civictech projects aimed at making government more transparent, efficient, and accessible to citizens.
